    ...
    <footer className="bg-[#0F172A] text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-white mb-4">FAQ</h3>
          ...
          <div>
            <h3 className="font-bold text-white mb-4">Download Aplikasi</h3>
            ...
            {/* Social Media Icons */}
            <div className="mt-6">
              <h3 className="text-sm mb-3">IKUTI KAMI</h3>
