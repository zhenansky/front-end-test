  ...
  return (
    <>
      <div className="my-20 px-10">
        <div className="w-full justify-normal flex flex-row gap-2">
          <h2 className="text-3xl text-white">Genre:</h2>
          <form class="max-w-sm text-3xl">
            <label for="underline_select" class="sr-only">
              Underline select
            </label>
            <select
              id="underline_select"
              class="block py-2.5 px-2 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"
            >
              <option selected>Pilih Genre</option>
              <option value="US">Action</option>
              <option value="CA">Horror</option>
              <option value="FR">Comedy</option>
